app.controller("StudentsFreshmenPostGraduateCollegeSectionSpecializationCtrl", function($scope, $log, $location) {
	...
	$scope.tagCategoryNames = [ 'YR', 'SS', 'DS', 'GR', 'IT', 'IN', 'CO', 'SE', 'SP', 'NA', 'GE' ];
