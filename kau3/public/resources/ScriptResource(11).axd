...
a.left=j.x;
a.top=j.y;
var d=c.width>5?c.width:parseInt(l.get_width());
a.width=d;
...
$telerik.$(f).animate(a,b,function(){e._onDockBeforeAnimationEnd(l,i,m);
});
...
return((c.get_dockMode()&Telerik.Web.UI.DockMode.Docked)>0&&(e.length==0||Array.indexOf(e,f)<0)&&(b.length==0||Array.indexOf(b,f)>=0)&&(a.length==0||Array.indexOf(a,d)>=0));
